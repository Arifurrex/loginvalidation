...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="../2-styles/main.css" />
    <title>alinessa it2 solution</title>
  </head>
  <body>
    <!-- ============================ -->
    ...
    <header>
      <nav>
        <!-- <a href="/index.html"> <h3>Alinessa</h3> </a> -->
        <a href="./index.php" class="logo-image">
          <img src="../../assets/alinessa_logo.png" alt="logo-light" />
        </a>
        <ul class="nav-list">
          <li class="nav-list-item">
            <a href="./src/3-pages/aboutus.php" class="black nav-links"
              >OUR COMPANY</a
            >
          </li>
          <li class="nav-list-item">
          ...
          <li class="nav-list-item">
            <a href="./src/3-pages/signup.html" class="black nav-links"
              >SIGN UP</a
            >
          </li>
          <li class="nav-list-item">
